...
function destroyExistingDataTable(tableId) {
    if ($.fn.DataTable.isDataTable(`#${tableId}`)) {
        ...
        console.log(`Previous ${tableId} DataTable instance destroyed`);
    }
}
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success && response.data) {
                ...
                console.error('Failed to load departments:', response.message || 'Unknown error');
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success && response.data) {
                ...
                console.error('Failed to load courses:', response.message || 'Unknown error');
