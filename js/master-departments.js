...
function initBasicDepartmentsTable() {
    try {
        ...
        departmentsTable = $('#departmentsTable').DataTable({
            ajax: {
                ...
                dataSrc: function(response) {
                    console.log('Department data received:', response);
        ...
        console.log('Departments table initialized successfully');
    } catch (error) {
...
function checkModals() {
    console.log('Checking for department modals:');
    console.log('Department Details Modal exists:', $('#departmentDetailsModal').length > 0);
...
function createDepartmentDetailsModal() {
    ...
    console.log('Department Details modal created dynamically');
}

function showDepartmentDetails(departmentId) {
    console.log('Showing details for Department ID:', departmentId);
